...
export function AuthModal() {
  ...
  return (
    <Modal
      ...
      title={null}
    >
      {/* Общий минимум высоты тела: вход/регистрация уже дают ~557px, а режим сброса
          короче — резервируем столько же и центрируем содержимое по вертикали, чтобы
          модалка не меняла размер ни на одной из вкладок. */}
      <Stack gap="xs" mih={557} justify={isAuth ? 'flex-start' : 'center'}>
