...
const COPY: Record<number, { title: string; description: string }> = {
  404: {
    ...
    description:
      'Возможно, ссылка устарела или в адресе опечатка. Вернёмся на главную — там всё на месте.',
  },
  503: {
  ...
  500: {
    ...
    description:
      'На нашей стороне произошла ошибка. Мы уже разбираемся — попробуйте обновить страницу или вернитесь на главную.',
  },
}
