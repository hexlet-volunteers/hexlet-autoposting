...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description: 'Напишет пост по теме, перепишет под площадку, предложит контент-план на месяц.',
    href: '/features/ai',
  },
  {
    icon: IconPhoto,
    title: 'Медиатека и черновики',
    description: 'Фото и видео в одном месте: шаблоны, водяные знаки, заготовки на будущее.',
  },
  {
    icon: IconUsers,
  ...
  },
  {
    ...
    description: 'Что вышло, когда и как сработало — сводка по всем площадкам в одном отчёте.',
  },
]
