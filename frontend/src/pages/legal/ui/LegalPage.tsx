          ...
          <Stack gap={24}>
            ...
            >
              ...
              <Clause term="2. Зачем.">
                ...
                статусе публикаций и поддержки. Мы не продаём данные третьим лицам и не читаем
                личные переписки.
              </Clause>
              ...
              <Clause term="5. Хранение.">
                Данные хранятся на серверах на территории Российской Федерации. При удалении
            ...
            >
              ...
              <Clause term="3. Ваши права.">
                Вы вправе запросить сведения об обработке, потребовать уточнения или удаления
                данных, а также отозвать согласие, написав на legal@otlozhka.ru.
              </Clause>
              <Clause term="4. Срок.">
